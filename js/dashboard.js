...
async function setup() {
  ...
  const totalConfirmedCasesLabel = document.getElementById(
    "confirmedCaseCount"
  );
  ...
  const totalRecoveryCasesLabel = document.getElementById("recoveryCaseCount");
  const labels = [
  ...
  const addedConfirmedValuesLabel = document.getElementById(
    "addedConfirmedCase"
  );
  ...
  const addedRecoveryValuesLabel = document.getElementById("addedRecoveryCase");
